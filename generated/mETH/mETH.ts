...
export class mETH extends ethereum.SmartContract {
  static bind(address: Address): mETH {
    return new mETH("mETH", address);
  }
  ...
  redeemToWETH(amount: BigInt): BigInt {
    let result = super.call("redeemToWETH", "redeemToWETH(uint256):(uint256)", [
      ethereum.Value.fromUnsignedBigInt(amount)
    ]);
  ...
  try_redeemToWETH(amount: BigInt): ethereum.CallResult<BigInt> {
    let result = super.tryCall(
      "redeemToWETH",
      "redeemToWETH(uint256):(uint256)",
      [ethereum.Value.fromUnsignedBigInt(amount)]
    );
    if (result.reverted) {
      return new ethereum.CallResult();
...
export class MintViaEtherCall extends ethereum.Call {
  get inputs(): MintViaEtherCall__Inputs {
    return new MintViaEtherCall__Inputs(this);
  }

  get outputs(): MintViaEtherCall__Outputs {
    return new MintViaEtherCall__Outputs(this);
  }
}

export class MintViaEtherCall__Inputs {
  _call: MintViaEtherCall;

  constructor(call: MintViaEtherCall) {
    this._call = call;
  }
}

export class MintViaEtherCall__Outputs {
  _call: MintViaEtherCall;
...
export class RedeemToWETHCall extends ethereum.Call {
  get inputs(): RedeemToWETHCall__Inputs {
    return new RedeemToWETHCall__Inputs(this);
  }

  get outputs(): RedeemToWETHCall__Outputs {
    return new RedeemToWETHCall__Outputs(this);
  }
}

export class RedeemToWETHCall__Inputs {
  _call: RedeemToWETHCall;

  constructor(call: RedeemToWETHCall) {
    this._call = call;
  }
...
export class RedeemToWETHCall__Outputs {
  _call: RedeemToWETHCall;
