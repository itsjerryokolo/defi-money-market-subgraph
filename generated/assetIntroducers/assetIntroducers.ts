...
export class assetIntroducers extends ethereum.SmartContract {
  static bind(address: Address): assetIntroducers {
    return new assetIntroducers("assetIntroducers", address);
  }
...
export class ConstructorCall__Inputs {
  ...
  get openSeaProxyRegistry(): Address {
  ...
  get dmgToken(): Address {
    return this._call.inputValues[6].value.toAddress();
  }

  get dmmController(): Address {
    return this._call.inputValues[7].value.toAddress();
  }

  get underlyingTokenValuator(): Address {
    return this._call.inputValues[8].value.toAddress();
  }

  get assetIntroducerDiscount(): Address {
