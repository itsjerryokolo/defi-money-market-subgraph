...
export class dmgGovernance__getActionsResult {
...
export class dmgGovernance__getReceiptResultValue0Struct extends ethereum.Tuple {
...
export class dmgGovernance__proposalsResult {
  value0: BigInt;
  value1: Address;
  value2: BigInt;
  value3: BigInt;
...
export class dmgGovernance extends ethereum.SmartContract {
  static bind(address: Address): dmgGovernance {
    return new dmgGovernance("dmgGovernance", address);
  }
  ...
  dmg(): Address {
    let result = super.call("dmg", "dmg():(address)", []);

    return result[0].toAddress();
  }

  try_dmg(): ethereum.CallResult<Address> {
    let result = super.tryCall("dmg", "dmg():(address)", []);
    if (result.reverted) {
      return new ethereum.CallResult();
    }
    let value = result.value;
  ...
  getActions(proposalId: BigInt): dmgGovernance__getActionsResult {
    let result = super.call(
      "getActions",
    ...
    return new dmgGovernance__getActionsResult(
  ...
  try_getActions(
    proposalId: BigInt
  ): ethereum.CallResult<dmgGovernance__getActionsResult> {
    let result = super.tryCall(
      "getActions",
      "getActions(uint256):(address[],uint256[],string[],bytes[])",
      [ethereum.Value.fromUnsignedBigInt(proposalId)]
    ...
    return ethereum.CallResult.fromValue(
      new dmgGovernance__getActionsResult(
  ...
  getReceipt(
    proposalId: BigInt,
    voter: Address
  ): dmgGovernance__getReceiptResultValue0Struct {
    let result = super.call(
      "getReceipt",
      "getReceipt(uint256,address):((bool,bool,uint128))",
      [
        ethereum.Value.fromUnsignedBigInt(proposalId),
    ...
    return result[0].toTuple() as dmgGovernance__getReceiptResultValue0Struct;
  }

  try_getReceipt(
    proposalId: BigInt,
    voter: Address
  ): ethereum.CallResult<dmgGovernance__getReceiptResultValue0Struct> {
    let result = super.tryCall(
      "getReceipt",
      "getReceipt(uint256,address):((bool,bool,uint128))",
      [
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      value[0].toTuple() as dmgGovernance__getReceiptResultValue0Struct
    );
  }
  ...
  proposals(param0: BigInt): dmgGovernance__proposalsResult {
    let result = super.call(
      "proposals",
    ...
    return new dmgGovernance__proposalsResult(
      result[0].toBigInt(),
      result[1].toAddress(),
      result[2].toBigInt(),
      result[3].toBigInt(),
  ...
  try_proposals(
    param0: BigInt
  ): ethereum.CallResult<dmgGovernance__proposalsResult> {
    let result = super.tryCall(
      "proposals",
      "proposals(uint256):(uint256,address,uint256,uint256,uint256,uint256,uint256,bool,bool)",
      [ethereum.Value.fromUnsignedBigInt(param0)]
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new dmgGovernance__proposalsResult(
        value[0].toBigInt(),
        value[1].toAddress(),
        value[2].toBigInt(),
        value[3].toBigInt(),
...
export class InitializeTimelockCall extends ethereum.Call {
  get inputs(): InitializeTimelockCall__Inputs {
    return new InitializeTimelockCall__Inputs(this);
  }

  get outputs(): InitializeTimelockCall__Outputs {
    return new InitializeTimelockCall__Outputs(this);
  }
}

export class InitializeTimelockCall__Inputs {
  _call: InitializeTimelockCall;

  constructor(call: InitializeTimelockCall) {
    this._call = call;
  }
...
export class InitializeTimelockCall__Outputs {
  _call: InitializeTimelockCall;
