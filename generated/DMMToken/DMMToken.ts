...
export class DMMToken__checkpointsResult {
  value0: BigInt;
  value1: BigInt;
...
export class DMMToken extends ethereum.SmartContract {
  static bind(address: Address): DMMToken {
    return new DMMToken("DMMToken", address);
  }

  APPROVE_TYPE_HASH(): Bytes {
    let result = super.call(
      "APPROVE_TYPE_HASH",
      "APPROVE_TYPE_HASH():(bytes32)",
      []
    );
  ...
  try_APPROVE_TYPE_HASH(): ethereum.CallResult<Bytes> {
  ...
  DELEGATION_TYPE_HASH(): Bytes {
    let result = super.call(
      "DELEGATION_TYPE_HASH",
      "DELEGATION_TYPE_HASH():(bytes32)",
      []
    );
  ...
  try_DELEGATION_TYPE_HASH(): ethereum.CallResult<Bytes> {
    let result = super.tryCall(
      "DELEGATION_TYPE_HASH",
      "DELEGATION_TYPE_HASH():(bytes32)",
      []
  ...
  try_burn(rawAmount: BigInt): ethereum.CallResult<boolean> {
  ...
  checkpoints(param0: Address, param1: BigInt): DMMToken__checkpointsResult {
    let result = super.call(
      "checkpoints",
      "checkpoints(address,uint64):(uint64,uint128)",
      [
    ...
    return new DMMToken__checkpointsResult(
      result[0].toBigInt(),
      result[1].toBigInt()
    );
  }
  ...
  try_checkpoints(
    param0: Address,
    param1: BigInt
  ): ethereum.CallResult<DMMToken__checkpointsResult> {
    let result = super.tryCall(
      "checkpoints",
      "checkpoints(address,uint64):(uint64,uint128)",
      [
    ...
    return ethereum.CallResult.fromValue(
      new DMMToken__checkpointsResult(value[0].toBigInt(), value[1].toBigInt())
    );
  }
  ...
  getCurrentVotes(account: Address): BigInt {
    let result = super.call(
      "getCurrentVotes",
      "getCurrentVotes(address):(uint128)",
      [ethereum.Value.fromAddress(account)]
    );
  ...
  getPriorVotes(account: Address, blockNumber: BigInt): BigInt {
    let result = super.call(
      "getPriorVotes",
      "getPriorVotes(address,uint256):(uint128)",
      [
        ethereum.Value.fromAddress(account),
  ...
  try_nonceOf(signer: Address): ethereum.CallResult<BigInt> {
...
export class ApproveBySigCall extends ethereum.Call {
  get inputs(): ApproveBySigCall__Inputs {
    return new ApproveBySigCall__Inputs(this);
  }

  get outputs(): ApproveBySigCall__Outputs {
    return new ApproveBySigCall__Outputs(this);
  }
}

export class ApproveBySigCall__Inputs {
  _call: ApproveBySigCall;

  constructor(call: ApproveBySigCall) {
    this._call = call;
  }
...
export class ApproveBySigCall__Outputs {
  _call: ApproveBySigCall;
...
export class TransferBySigCall extends ethereum.Call {
  get inputs(): TransferBySigCall__Inputs {
    return new TransferBySigCall__Inputs(this);
  }

  get outputs(): TransferBySigCall__Outputs {
    return new TransferBySigCall__Outputs(this);
  }
}

export class TransferBySigCall__Inputs {
  _call: TransferBySigCall;

  constructor(call: TransferBySigCall) {
    this._call = call;
  }
...
export class TransferBySigCall__Outputs {
  _call: TransferBySigCall;
